...
class Searchbar {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, createColorClasses(this.color), { [`${this.mode}`]: true, 'searchbar-animated': animated, 'searchbar-no-animate': animated && this.noAnimate, 'searchbar-has-value': (this.getValue() !== ''), 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused })
        };
    }
    render() {
